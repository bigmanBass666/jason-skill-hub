...
def parse_stream_output(buffer: str, clean_name: str, skill_name: str) -> bool:
    ...
    for line in buffer.split("\n"):
            ...
            if se_type == "content_block_start":
                ...
                if cb.get("type") == "tool_use":
                    ...
                    if tool_name in ("Skill", "Read"):
                        ...
                        # Wrong tool triggered — skill not invoked
                        return False
        ...
        # Full assistant message (fallback when streaming not used)
...
def run_single_query(
    ...
    Uses --include-partial-messages to detect triggering from
    ...
    try:
        ...
        try:
            ...
            buffer = stdout_bytes.decode("utf-8", errors="replace")
