...
**第二步**: 复制它的 Raw URL，访问抓取 **完整的 SKILL.md 原文**

**第三步**: 如果 SKILL.md 中提到 `references/` 或其他目录下的文件，**必须先访问该目录的 Raw URL 获取真实文件列表**，然后再读取具体文件。**绝对不能仅凭 SKILL.md 中的引用路径推断文件是否存在**

> **⚠️ 强制要求**：
> - 你必须实际访问 Raw URL 获取 SKILL.md 内容，**不能仅凭 description 推断**
> - 抓取后必须先输出 SKILL.md 的完整内容，证明你真的读取了
> - 必须按照 SKILL.md 里的步骤执行
> - **如果 SKILL.md 提到其他目录文件，必须先访问该目录获取真实文件列表**
>   - 目录 Raw URL 格式：`{skill目录Raw URL所在父目录}/{子目录名}/`
>   - 例如 SKILL.md 在 `skills/awwwards-design/SKILL.md`，则 `references/` 的目录 URL 为 `https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/awwwards-design/references/`
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/arch-design/SKILL.md
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/article-to-image-prompt/SKILL.md
...
### canvas-design
- **Description**: 
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/canvas-design/SKILL.md
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/code-refactor/SKILL.md

### daily-summary
- **Description**: 以 AI 第一人称视角，总结用户在 Claude Code 中的对话活动，生成日记形式的工作记录。
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/daily-summary/SKILL.md

### diary-recorder
- **Description**: 以 AI 第一人称视角，根据真实 Claude 对话、本地 Claude 记录，以及用户提供的日记草稿或笔记，生成可写入日记的成稿。文风可偏文学，但不得虚构事实。
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/diary-recorder/SKILL.md

### doc-coauthoring
- **Description**: 
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/doc-coauthoring/SKILL.md

### docx
- **Description**: 
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/docx/SKILL.md
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/gitignore-gen/SKILL.md

### learning-report
- **Description**: 以 AI 第一人称视角、用户作为主角，生成学习过程报告。用于总结用户在一次协作中展现的能力、思维过程和学习成果。
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/learning-report/SKILL.md

### long-running-agent
- **Description**: Long-running agent implementation based on Anthropics Effective harnesses for long-running agents article
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/long-running-agent/SKILL.md
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/process-cleanup/SKILL.md
...
### webapp-testing
- **Description**: 
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/webapp-testing/SKILL.md

### xlsx
- **Description**: 
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/xlsx/SKILL.md
...
- **Raw URL**: https://raw.githubusercontent.com/bigmanBass666/jason-skill-hub/master/skills/zai-consult/SKILL.md
